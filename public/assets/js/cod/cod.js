...
function viewDetail(id = '')
{
    ...
    var cod_remittance_order_detail_table = $('#cod_remittance_order_detail_table').DataTable({
        ajax:{
            url: "/admin/cod_remittance_order_detail_table",
            data:{id:id}
        },
        columns: [
        ...
        "language": {
            "emptyTable": '<div class="align-items-center d-flex flex-column justify-content-center zero-data-screen ng-star-inserted no-record-found"> <div class="mb-20px"> <img width="210" src="/assets/images/3.svg" alt="No Orders Found" /> </div> <div class="mb-27px display-4 heading">No Record Found</div> <div class="cta-section"></div> </div>',
            "zeroRecords": '<div class="align-items-center d-flex flex-column justify-content-center zero-data-screen ng-star-inserted no-record-found"> <div class="mb-20px"> <img width="210" src="/assets/images/3.svg" alt="No Orders Found" /> </div> <div class="mb-27px display-4 heading">No Record Found</div> <div class="cta-section"></div> </div>',
        },
        bLengthChange: false,
        processing: true,
        serverSide: true,
...
var codWalletTransactionsTable = $('#cod_wallet_transactions').DataTable({
    ajax: "/admin/cod-wallet-transactions",
    columns: [
...
var allCodRemittanceListTable = $('#allCodRemittanceList').DataTable({
    ajax: "/admin/all-cod-remittance-list",
    columns: [
        {data: 'created_at', name: 'created_at'},
        {data: 'cod_remittance_amount', name: 'cod_remittance_amount'},
        {data: 'cod_remittance_note', name: 'cod_remittance_note'},
...
var nextCodRemittanceAllDataTable = $('#nextCodRemittanceAllData').DataTable({
    ajax: "/admin/next-cod-remittance-all-data",
    columns: [
        {data: 'name', name: 'name'},
...
function codRemittanceListDatatable(user_id = '', from_date = '', to_date = '')
{
    var codRemittanceList = $('#codRemittanceList').DataTable({
        ajax:{
            url: "/admin/cod-remittance-lists",
...
function nextCodRemittanceListDatatable(from_date = '', to_date = '')
{
    ...
    var nextCodRemittanceList = $('#nextCodRemittanceList').DataTable({
        ajax:{
            url: "/admin/next-cod-remittance-list",
