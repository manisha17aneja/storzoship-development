$(document).ready(function() {
    ...
    //************************************** shopify-waiting Start ********************************************//
    
    // shopify-waiting
    
    var shopifyWaitingTable = $('#admin_shopify-waiting').DataTable({
        ajax: "user/orders/shopify-waiting-order-list",
        columns: [
            ...
            {data: 'total_shipping_amount', name: 'total_shipping_amount'},
        ...
        initComplete: function() {
            ...
            $( ".shopify-waiting_exports" ).click(function() {
               console.log('export');
