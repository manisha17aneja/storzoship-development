$(document).ready(function() {
    ...
    var rtoDeliveredTable = $('#admin_rto-delivered').DataTable({
        ajax: "user/orders/rto-delivered-order-list",
        columns: [
        ...
        initComplete: function() {
            ...
            $( ".rto-delivered_exports" ).click(function() {
               console.log('export');
