            ...
            <div class="bg-white py-4 px-2">
              <div class="row align-items-baseline justify-content-between pt-4 pb-3 px-2 flex-wrap ng-star-inserted">
                <div class="col-lg-3 col-md-2 col-sm-2 col-3">
                  <h3 class="fs-20px text-dark mb-0">COD Remittance</h3>
                </div>
                                ...
                                <div class="group-position1  d-lg-block">
                                    <div class="d-flex align-items-center ng-star-inserted">
                                        ...
                                        <div class="form-group mb0 text-end">
                                            <button type="button" name="seach_cod_remittance_list" id="seach_cod_remittance_list">Submit</button>

                                            <button type="button" name="reset" id="reset_cod_remittance_list" class="btn btn-primary">Reset</button>
                                        </div>
                        ...
                        <div class="card p-0">
                          <div class="card-body p-0">
                            <div class="table-responsive order-container tableFixHead">
                              <table class="table table-striped table-hover no-wrap codRemittanceList" id="codRemittanceList">
                                <thead>
                                  <tr>
