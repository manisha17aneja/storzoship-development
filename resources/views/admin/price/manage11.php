...
<div class="page">
	...
	<div class="page-content">
		...
		<?php if(@$logistic_price) { ?>
			<!--<form method="post" name="shipping_charge" action="{{ route('manage.price.store') }}" data-parsley-validate>-->
            <form class="ng-pristine ng-invalid ng-touched addManagePriceForm" action="{{ route('manage.price.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
