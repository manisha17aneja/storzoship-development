                              ...
                              >
                                <div class="ng-star-inserted">
                                 <!-- <form class="ng-untouched ng-pristine ng-invalid"> -->
                                  ...
                                  <form class="ng-untouched ng-pristine ng-invalid buyerDetailForm" action="{{ route('buyer.details.store') }}" method="POST" enctype="multipart/form-data">
                                     @csrf
                                    <h6
                                      ...
                                      <div class="row">
                                        <div class="col-md-4">
                                          ...
                                          <div class="custom-mob-css">
                                            ...
                                            <span class="text-danger error-text customer_mobile_err"></span>
                                          </div>
                                        </div>
                                        ...
                                        <div class="row">
                                          <div class="col-md-6">
                                            ...
                                            ><input
                                              ...
                                              formcontrolname="customer_address1"
                                              class="form-control ng-untouched ng-pristine ng-invalid"
                                            />
                                            <span class="text-danger error-text customer_address1_err"></span>
                                          </div>
                                          <div class="col-md-6 custom_margin_top_md">
                                            ...
                                            ><input
                                              ...
                                              formcontrolname="customer_address2"
                                              class="form-control ng-untouched ng-pristine ng-valid"
                                            />
                                            <span class="text-danger error-text customer_address2_err"></span>
                                          </div>
                                        </div>
                                        <div class="row mt-4 --changed">
                                          <div class="col-md-4">
                                            <label>Pincode</label
                                            ><input
                                              type="text"
                                          ...
                                          <div
                                            class="col-md-4 custom_margin_top_md ng-star-inserted"
                                          >
                                            <label>State</label
                                            ><input
                                              type="text"
                                    ...
                                    <div class="text-end">
                                      <button type="submit" class="buyerDetailSubmit">Next</button>
                                    </div> 
                                  </form>
                                </div>
                              </div>
