                        ...
                        <div class="mat-tab-group mat-primary">
                          ...
                          <div class="mat-tab-body-wrapper">
                            ...
                            >
                              ...
                              >
                                <div class="ng-star-inserted">
                                <form class="ng-untouched ng-pristine ng-invalid orderDetailForm" action="{{ route('order.details.store') }}" method="POST" enctype="multipart/form-data">
                                     @csrf
                                    <h6
                                    ...
                                    <div class="row mt-3 --changed">
                                          <div class="col-md-4">
                                            ...
                                            />
                                            <span class="text-danger error-text order_number_err"></span>
                                          </div>
                                          <div class="col-md-4 custom_margin_top_md">
                                            ...
                                            <span class="text-danger error-text order_type_err"></span>
                                          </div>
                                      ...
                                      <div class="col-md-3 custom_margin_top_md">
                                        ...
                                        <div class="col-md-3 custom_margin_top_md">
                                          ...
                                          />
                                          <span class="text-danger error-text product_quantity_err"></span>
                                        </div>
                                        ...
                                        <div class="col-md-3 custom_margin_top_md">
                                          ...
                                          ><input
                                            ...
                                            class="form-control ng-untouched ng-pristine ng-valid"
                                          />
                                          <span class="text-danger error-text sku_err"></span>
                                        </div>
                                      ...
                                      <div class="mt-4">
                                        <p>
                                          <label
                                            ...
                                            <br><span class="text-danger error-text seller_info_err"></span>
                                        </p>
                                      </div>
                                     ...
                                     <br>
                                      ...
                                      <div class="col-md-6 custom_margin_top_md">
                                          ...
                                          ><input
                                            ...
                                            class="form-control ng-untouched ng-pristine ng-invalid"
                                          />
                                          <span class="text-danger error-text reseller_name_err"></span>
                                        </div>
